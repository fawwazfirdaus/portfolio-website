...
if (!private_key) {
  console.error("Error: APPLE_PRIVATE_KEY is not set. Please set this environment variable.");
  process.exit(1);
}

if (!team_id) {
  console.error("Error: APPLE_TEAM_ID is not set. Please set this environment variable.");
  process.exit(1);
}

if (!client_id) {
  console.error("Error: APPLE_CLIENT_ID is not set. Please set this environment variable.");
  process.exit(1);
}

if (!key_id) {
  console.error("Error: APPLE_KEY_ID is not set. Please set this environment variable.");
  process.exit(1);
}
