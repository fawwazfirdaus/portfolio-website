...
export function SignIn() {
  return (
    <div className="flex flex-col space-y-2 mb-8 max-w-[250px]">
      <button
      ...
      >
        <img alt="GitHub logo" src="/github-logo.svg" width="20" height="20" className="invert dark:invert-0" />
      ...
      >
        <img alt="Apple logo" src="/apple-logo.svg" width="20" height="20" className="invert dark:invert-0" />
